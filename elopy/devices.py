...
class Computer(object):
    ...
    #global_clock=monotonicClock  # TODO
    global_clock=None
    ...
    try:
        ...
        processing_unit_count = psutil.NUM_CPUS
        core_count = psutil.NUM_CPUS #hyperthreads not included
    ...
    try:
        _process_original_nice_value=psutil.Process(os.getpid()).nice() # used on linux.
    except:
        _process_original_nice_value=psutil.Process(os.getpid()).nice
